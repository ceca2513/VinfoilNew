...
import org.vinfoil.RepassingResultsOneLaneTwoTimes;
import org.vinfoil.SetOfPatternsForALane;
import org.vinfoil.Triangel;

public class DrawOneOnOneTwoTimes extends JPanel{
	protected Patterns allPatterns;;
	protected RepassingResultsOneLaneTwoTimes ResultList;

	
	public DrawOneOnOneTwoTimes(RepassingResultsOneLaneOnly result){
		super();
	...
	private void DrawResults(Graphics g) {
		...
		Patterns patterns1=set.PatternsForOneLane(this.allPatterns, this.ResultList.getLane3());
		...
		g2.setColor(Color.GREEN);
		 ...
		 ((Graphics2D) g).setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER,0.8f));
		 theFWL2.x=(int) (ResultList.getLane2().getStart()+ResultList.getHS1().getShiftX()+OriginX);
		 theFWL2.y=ResultList.getHS1().getShiftY()+OriginY;
		 ...
		 for(int i=0;i<patterns.getRectangels().size();i++){
			 ...
			 theFWL1.x=(int) (r.getX11()+OriginX+ResultList.getHS1().getShiftX());
			 theFWL1.y=(int)(r.getY12()+OriginY+ResultList.getHS1().getShiftY());
			 theFWL1.width=(int)(r.getX12()-r.getX11());
			 theFWL1.height=(int) (r.getY11()-r.getY12());
		 ...
		 for(int i=0;i<patterns.getParallelograms().size();i++){
			 ...
			 theParallelogram.addPoint((int)p.getX11()+ResultList.getHS1().getShiftX(), (int)p.getY11()+ResultList.getHS1().getShiftY());
			 theParallelogram.addPoint((int)p.getX12()+ResultList.getHS1().getShiftX(), (int)p.getY12()+ResultList.getHS1().getShiftY());
			 theParallelogram.addPoint((int)p.getX13()+ResultList.getHS1().getShiftX(), (int)p.getY13()+ResultList.getHS1().getShiftY());
			 theParallelogram.addPoint((int)p.getX14()+ResultList.getHS1().getShiftX(), (int)p.getY14()+ResultList.getHS1().getShiftY());
		 ...
		 for(int i=0;i<patterns.getTriangels().size();i++){
			 ...
			 theTriangel.addPoint((int)t.getX11()+ResultList.getHS1().getShiftX(), (int)t.getY11()+ResultList.getHS1().getShiftY());
			 theTriangel.addPoint((int)t.getX12()+ResultList.getHS1().getShiftX(), (int)t.getY12()+ResultList.getHS1().getShiftY());
			 theTriangel.addPoint((int)t.getX13()+ResultList.getHS1().getShiftX(), (int)t.getY13()+ResultList.getHS1().getShiftY());
		 ...
		 g2.setColor(Color.LIGHT_GRAY);
		 ((Graphics2D) g).setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER,0.8f));
		 theFWL2.x=(int) (ResultList.getLane4().getStart()+ResultList.getHS2().getShiftX()+OriginX);
		 theFWL2.y=ResultList.getHS2().getShiftY()+OriginY;
		 theFWL2.width=(int) ResultList.getLane1().getWidth();
		 theFWL2.width=(int) ResultList.getLane1().getLength();
		 ...
		 for(int i=0;i<patterns1.getRectangels().size();i++){
			 ...
			 theFWL1.x=(int) (r.getX11()+OriginX+ResultList.getHS2().getShiftX());
			 theFWL1.y=(int)(r.getY12()+OriginY+ResultList.getHS2().getShiftY());
			 theFWL1.width=(int)(r.getX12()-r.getX11());
			 theFWL1.height=(int) (r.getY11()-r.getY12());
		 ...
		 for(int i=0;i<patterns1.getParallelograms().size();i++){
			 ...
			 theParallelogram.addPoint((int)p.getX11()+ResultList.getHS2().getShiftX(), (int)p.getY11()+ResultList.getHS2().getShiftY());
			 theParallelogram.addPoint((int)p.getX12()+ResultList.getHS2().getShiftX(), (int)p.getY12()+ResultList.getHS2().getShiftY());
			 theParallelogram.addPoint((int)p.getX13()+ResultList.getHS2().getShiftX(), (int)p.getY13()+ResultList.getHS2().getShiftY());
			 theParallelogram.addPoint((int)p.getX14()+ResultList.getHS2().getShiftX(), (int)p.getY14()+ResultList.getHS2().getShiftY());
		 ...
		 for(int i=0;i<patterns1.getTriangels().size();i++){
			 ...
			 theTriangel.addPoint((int)t.getX11()+ResultList.getHS2().getShiftX(), (int)t.getY11()+ResultList.getHS2().getShiftY());
			 theTriangel.addPoint((int)t.getX12()+ResultList.getHS2().getShiftX(), (int)t.getY12()+ResultList.getHS2().getShiftY());
			 theTriangel.addPoint((int)t.getX13()+ResultList.getHS2().getShiftX(), (int)t.getY13()+ResultList.getHS2().getShiftY());
