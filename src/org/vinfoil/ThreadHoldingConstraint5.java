...
public class ThreadHoldingConstraint5 extends Thread {
	...
	public ThreadHoldingConstraint5(){
		//constructor
		super();
	}
	...
	public List <HoldingResult> Direction5(){
		...
		for(int i=1;i<ShiftX;i++)
			for(int j=1;j<ShiftY;j++){
				...
				matrixTemp=zp.Shifting(matrixPadded, i, j, this.n1, this.m, 5);
