...
public class THC1 extends Thread {
    ...
    public void run() {
        ...
        this.HS.addAll(Direction1());

        System.out.println("first thread 1 " + this.HS.size());

    }

    public THC1(List<Direction1andDirection2> HS) {
        this.HS = HS;
    }
    ...
    public List<Direction1andDirection2> Direction1() {
