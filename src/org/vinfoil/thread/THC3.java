...
public class THC3 extends Thread{
  ...
  public void setHs(List <Direction1andDirection2> hs){
	...
	public void run() {
		...
		this.HS.addAll(this.Direction3());
		System.out.println("third thread 1 "+this.HS.size());
	}
	public THC3(List<Direction1andDirection2> HS){
		this.HS = HS;
	}
	...
	public List<Direction1andDirection2> Direction3(){
