...
public class THC8 extends Thread{
  ...
  public void setHs(List <Direction1andDirection2> hs){
  	...
  	public List <Direction1andDirection2> Direction8(){
  		...
  		List <Point> listOfEmbeding=Collections.synchronizedList(new ArrayList <Point>());
  			...
  			for(int j=0;j<ShiftY;j++){
  				...
  				matrixTemp=zp.Shifting(matrixPadded, 0, j, this.n1, this.m, 8);
