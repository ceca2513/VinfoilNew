...
public class ThreadHoldingConstraint2 extends Thread{
	...
	public ThreadHoldingConstraint2(){
		//constructor
		super();
	}
	...
	public List <HoldingResult> Direction2(){
		...
		for(int i=0;i<ShiftX;i++){
				...
				if(shift==false){
					...
					listOfEmbeding=over.ScaningForEmbedingWithTwoLanes(this.discreteLane1, matrixTemp, this.ScanStep, this.n1, this.m, this.X1min, this.X1max, this.X2min-i, this.X2max-i, this.Y1min, this.Y1max, this.Y2min, this.Y2max);
