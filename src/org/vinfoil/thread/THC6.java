...
public class THC6 extends Thread{
  ...
  public void setHs(List <Direction1andDirection2> hs){
  	...
  	public void run() {
  		...
  		System.out.println("sixth thread 1 "+this.HS.size());
  	}
  	public THC6(List<Direction1andDirection2> HS){
		this.HS = HS;
  	}
  	...
  	public List <Direction1andDirection2> Direction6(){
