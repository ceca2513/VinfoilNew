...
public class ThreadHoldingConstraint31 extends Thread{
	...
	public void run() {
		...
		this.HS.addAll(Direction3());
		System.out.println("third thread "+this.HS.size());
	}
	public ThreadHoldingConstraint31(List<HoldingResult> HS){
		this.HS = HS;
	}
