...
public class THC5 extends Thread{
  ...
  public void setHs(List <Direction1andDirection2> hs){
  	...
  	public void run() {
  		...
  		System.out.println("fifth thread 1 "+this.HS.size());
  	}
  	public THC5(List<Direction1andDirection2> HS){
		this.HS = HS;
  	}
  	...
  	public List <Direction1andDirection2> Direction5(){
