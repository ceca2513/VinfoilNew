...
public class OneOnTwoRepass {
	...
	public List <Direction1andDirection2> OneOnTwoRepassRun(FWL lane1, FWL lane2, FWL lane3, Patterns Shape, int ScanStep){
		...
		//moras prvo negde da sacuvas rezultate
		/*try{
			thc11.join();
		...
		boolean t=false;
			...
			synchronized(HS){
		       ...
		       while (iterator1.hasNext()&&t==false){
		    	   ...
		    	   int X1minTemp=X1min; int X1maxTemp=X1max;
		    	   int Y1minTemp=Y1min; int Y1maxTemp=Y1max;
		    	...
		    	thc1.setDiscreteLane1(matrixdis5);thc1.setDiscreteLane2(matrixdis4);
		   		thc1.setX1min(X1minTemp);thc1.setX1max(X1maxTemp);
		   		thc1.setX2min(X3min);thc1.setX2max(X3max);
		   		thc1.setY1min(Y1minTemp);thc1.setY1max(Y1maxTemp);
		   		thc1.setY2min(Y3min);thc1.setY2max(Y3max);
		   		...
		   		thc1.setN1((int)lane1.getWidth());thc1.setN2((int)lane3.getWidth());
		   		thc1.setM((int)lane1.getLength());thc1.setScanStep(ScanStep);
		   	
				thc1.run(); templist.addAll(thc1.getHS());
			...
			synchronized(HS){
		       ...
		       while (iterator1.hasNext()&&t==false){
		   		...
		   		thc2.setDiscreteLane1(matrixdis5);thc2.setDiscreteLane2(matrixdis4);
		   		thc2.setX1min(X1minTemp);thc2.setX1max(X1maxTemp);
		   		thc2.setX2min(X3min);thc2.setX2max(X3max);
		   		thc2.setY1min(Y1minTemp);thc2.setY1max(Y1maxTemp);
		   		thc2.setY2min(Y3min);thc2.setY2max(Y3max);
		   		thc2.setN1((int)lane1.getWidth());thc2.setN2((int)lane3.getWidth());
		   		thc2.setM((int)lane1.getLength());thc2.setScanStep(ScanStep);
				...
				thc2.start();templist.addAll(thc2.getHS());
		       ...
		       synchronized(HS){
		   		...
		   		thc3.setDiscreteLane1(matrixdis5);thc3.setDiscreteLane2(matrixdis4);
		   		thc3.setX1min(X1minTemp);thc3.setX1max(X1maxTemp);
		   		thc3.setX2min(X3min);thc3.setX2max(X3max);
		   		thc3.setY1min(Y1minTemp);thc3.setY1max(Y1maxTemp);
		   		thc3.setY2min(Y3min);thc3.setY2max(Y3max);
		   		thc3.setN1((int)lane1.getWidth());thc3.setN2((int)lane3.getWidth());
		   		thc3.setM((int)lane1.getLength());thc3.setScanStep(ScanStep);
				...
				thc3.run();templist.addAll(thc3.getHS());
		       ...
		       synchronized(HS){
		   		...
		   		thc4.setDiscreteLane1(matrixdis5);thc4.setDiscreteLane2(matrixdis4);
		   		thc4.setX1min(X1minTemp);thc4.setX1max(X1maxTemp);
		   		thc4.setX2min(X3min);thc4.setX2max(X3max);
		   		thc4.setY1min(Y1minTemp);thc4.setY1max(Y1maxTemp);
		   		thc4.setY2min(Y3min);thc4.setY2max(Y3max);
		   		thc4.setN1((int)lane1.getWidth());thc4.setN2((int)lane3.getWidth());
		   		thc4.setM((int)lane1.getLength());thc4.setScanStep(ScanStep);
				...
				thc4.run();templist.addAll(thc4.getHS());
		       ...
		       synchronized(HS){
		   		...
		   		thc5.setDiscreteLane1(matrixdis5);thc5.setDiscreteLane2(matrixdis4);
		   		thc5.setX1min(X1minTemp);thc5.setX1max(X1maxTemp);
		   		thc5.setX2min(X3min);thc5.setX2max(X3max);
		   		thc5.setY1min(Y1minTemp);thc5.setY1max(Y1maxTemp);
		   		thc5.setY2min(Y3min);thc5.setY2max(Y3max);
		   		thc5.setN1((int)lane1.getWidth());thc5.setN2((int)lane3.getWidth());
		   		thc5.setM((int)lane1.getLength());thc5.setScanStep(ScanStep);
				...
				thc5.run();templist.addAll(thc5.getHS());
		       ...
		       synchronized(HS){
		   		...
		   		thc6.setDiscreteLane1(matrixdis5);thc6.setDiscreteLane2(matrixdis4);
		   		thc6.setX1min(X1minTemp);thc6.setX1max(X1maxTemp);
		   		thc6.setX2min(X3min);thc6.setX2max(X3max);
		   		thc6.setY1min(Y1minTemp);thc6.setY1max(Y1maxTemp);
		   		thc6.setY2min(Y3min);thc6.setY2max(Y3max);
		   		thc6.setN1((int)lane1.getWidth());thc6.setN2((int)lane3.getWidth());
		   		thc6.setM((int)lane1.getLength());thc6.setScanStep(ScanStep);
				...
				thc6.run();templist.addAll(thc6.getHS());
		       ...
		       synchronized(HS){
		   		...
		   		thc7.setDiscreteLane1(matrixdis5);thc7.setDiscreteLane2(matrixdis4);
		   		thc7.setX1min(X1minTemp);thc7.setX1max(X1maxTemp);
		   		thc7.setX2min(X3min);thc7.setX2max(X3max);
		   		thc7.setY1min(Y1minTemp);thc7.setY1max(Y1maxTemp);
		   		thc7.setY2min(Y3min);thc7.setY2max(Y3max);
		   		thc7.setN1((int)lane1.getWidth());thc7.setN2((int)lane3.getWidth());
		   		thc7.setM((int)lane1.getLength());thc7.setScanStep(ScanStep);
				...
				thc7.start();templist.addAll(thc7.getHS());
		       ...
		       synchronized(HS){
		   		...
		   		thc8.setDiscreteLane1(matrixdis5);thc8.setDiscreteLane2(matrixdis4);
		   		thc8.setX1min(X1minTemp);thc8.setX1max(X1maxTemp);
		   		thc8.setX2min(X3min);thc8.setX2max(X3max);
		   		thc8.setY1min(Y1minTemp);thc8.setY1max(Y1maxTemp);
		   		thc8.setY2min(Y3min);thc8.setY2max(Y3max);
		   		thc8.setN1((int)lane1.getWidth());thc8.setN2((int)lane3.getWidth());
		   		thc8.setM((int)lane1.getLength());thc8.setScanStep(ScanStep);
				...
				thc8.start();templist.addAll(thc8.getHS());
				i++;
				if(templist.size()>0){
					t=true;
