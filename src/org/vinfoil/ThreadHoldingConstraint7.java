...
public class ThreadHoldingConstraint7 extends Thread{

	@Override
	public void run() {
		// TODO Auto-generated method stub
		this.HS=this.Direction7();
		System.out.println("seventh thread "+this.HS.size());
	}
	public ThreadHoldingConstraint7(){
		//constructor
		super();
	}
	...
	public List <HoldingResult> Direction7(){
		...
		for(int i=1;i<ShiftX;i++)
			for(int j=1;j<ShiftY;j++){
				...
				matrixTemp=zp.Shifting(matrixPadded, i, j, this.n1, this.m, 7);
